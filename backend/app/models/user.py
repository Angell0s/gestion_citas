...
class User(Base, TimestampMixin):
    ...
    businesses: Mapped[list["Businesses"]] = relationship(back_populates="owner", cascade="all, delete-orphan")

    memberships: Mapped[List["BusinessMember"]] = relationship("BusinessMember", back_populates="user")
